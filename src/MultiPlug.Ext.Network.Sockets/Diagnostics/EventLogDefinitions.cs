...
namespace MultiPlug.Ext.Network.Sockets.Diagnostics
{
    internal class EventLogDefinitions
    {
        ...
        internal static EventLogDefinition[] Definitions { get; set; } = new EventLogDefinition[]
        {
            ...
            new EventLogDefinition { Code = (uint) EventLogEntryCodes.WaitingForConnection, Source = (uint) EventLogEntryCodes.SourceSocketEndpointListener, StringFormat = "Waiting for a new connection", Type = EventLogEntryType.Information },
            ...
            new EventLogDefinition { Code = (uint) EventLogEntryCodes.SocketEndpointSocketClosed, Source = (uint) EventLogEntryCodes.SourceSocketEndpoint, StringFormat = "Socket Closed. IP: {0}", Type = EventLogEntryType.Information },
            ...
            new EventLogDefinition { Code = (uint) EventLogEntryCodes.SocketEndpointClosedWhileReceive, Source = (uint) EventLogEntryCodes.SourceSocketEndpoint, StringFormat = "Socket Closed. IP: {0}", Type = EventLogEntryType.Warning },
