...
namespace MultiPlug.Ext.Network.Sockets.Diagnostics
{
    internal class EventLogDefinitions
    {
        ...
        internal static EventLogDefinition[] Definitions { get; set; } = new EventLogDefinition[]
        {
            ...
            new EventLogDefinition { Code = (uint) EventLogEntryCodes.SocketEndpointDataReceived, Source = (uint) EventLogEntryCodes.SourceSocketEndpointListener, StringFormat = "Data Received", Type = EventLogEntryType.Information },
            ...
            new EventLogDefinition { Code = (uint) EventLogEntryCodes.SocketEndpointExceptionDiconnected, Source = (uint) EventLogEntryCodes.SourceSocketEndpointListener, StringFormat = "Disconnected {0} Code {1}", Type = EventLogEntryType.Warning },
            new EventLogDefinition { Code = (uint) EventLogEntryCodes.SocketEndpointSent, Source = (uint) EventLogEntryCodes.SourceSocketEndpointListener, StringFormat = "{0} Bytes Sent", Type = EventLogEntryType.Information },
            ...
            new EventLogDefinition { Code = (uint) EventLogEntryCodes.SocketClientReceivedData, Source = (uint) EventLogEntryCodes.SourceSocketClient, StringFormat = "Received data: {0}", Type = EventLogEntryType.Information },
